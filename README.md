...
- Features:
  ...
  - Join tables to show enrolled courses and grades
  - Aggregate queries (e.g., students per course)
- File: `student_database_project.sql`
...
Here is a clean, professional, **GitHub-ready README section** that you can directly paste into your existing SQL projects repository.

I prepared it in the **same style** as your previous project descriptions (Student DB, Library DB, E-commerce DB), so it will fit perfectly.
